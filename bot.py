...
7. Будь позитивным и дружелюбным
8. Используй имя пользователя, когда уместно"""
...
⚙️ **ДЛЯ ХОЗЯИНА:**
• настройки, макс токенов, температура, режим краткий/подробный/нормальный
